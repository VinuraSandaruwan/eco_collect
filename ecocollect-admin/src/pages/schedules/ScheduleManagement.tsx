...
import type { ScheduleItem } from "../../types/database.types";
import { getSchedules, addSchedule, updateScheduleStatus } from "../../services/apiService";
...
function ScheduleManagement() {
  ...
  const handleAddSchedule = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.routeCode || !form.serviceArea) return;
    setSubmitting(true);
      ...
      <div className="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
        <div>
          ...
          <p className="text-muted mb-0">
            Dispatch trucks, track route progress, and optimize daily waste collection.
          </p>
        </div>
        <button
        ...
        <div className="card-header bg-white d-flex flex-wrap gap-3 justify-content-between align-items-center py-3">
          <div className="position-relative" style={{ minWidth: "260px", flex: 1 }}>
            ...
            <input
              ...
              placeholder="Search by route code, sector, vehicle..."
              value={search}
              ...
              {loading ? (
                <tr>
                  <td colSpan={6} className="text-center text-muted py-5">
                    ...
                    Fetching schedules from Supabase...
                  </td>
                </tr>
              ) : (
                filtered.map((s) => (
                  <tr key={s.id}>
                    ...
                    <td className="small text-muted">{s.driver_team}</td>
                    <td>
            ...
            <div className="modal-content border-0 shadow">
              ...
              <form onSubmit={handleAddSchedule}>
                <div className="modal-body p-4">
                  ...
                  <div className="row g-3 mb-3">
                    <div className="col-6">
                      <label className="form-label small fw-bold text-muted text-uppercase">Assigned Vehicle</label>
                      <input
                        type="text"
                        className="form-control"
                        value={form.vehicle}
